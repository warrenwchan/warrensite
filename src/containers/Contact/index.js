            ...
            <section className="ContactContainer">
              ...
              <form name="contact" method="POST" data-netlify="true">
                <div className="inputFields">
                  ...
                  <input type="text" name="name" placeholder="And your last name?"/>
                </div>
                <div className="inputFields">
                  <input type="email" name="email" placeholder="How about your email"/>
                  <input type="tel" name="phone" placeholder="Let me get down your phone number"/>
                </div>
                <div>
